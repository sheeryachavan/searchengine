...
db = client.foodfood  # for food food
# db = client.foodrepublic #for food republic
...
with client:
    ...
    recipes = db.reviews.find()  # for food food
    # recipes = db.fr_recipes.find() #for food republic
